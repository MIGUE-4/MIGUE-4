...
<table style="border: none;">
  <tr style="border: none;">
    ...
    <td style="border: none;">
      ...
      Mi nombre es Miguel, soy estudiante de estadística, un chico que tiene claro que quedará calvo algún día...(eh<br>
      ahí porqué el casco de Darth Vader)Soy un aficionado a las tecnologías, especialmente en el área de análisis de  <br>
